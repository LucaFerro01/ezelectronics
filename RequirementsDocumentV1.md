...
## Table
  ...
  1. **User**: un utente caratterizzato dal assegnazione di uno tra due ruoli:
     - **Menager**(a): utente che gestisce i prodotti all'interno del magazzino (inserendo i nuovi prodotti arrivati, eliminando quelli non più disponibili, gestendo l'invio dei prodotti acquistati dai customer)
     - **Menager**(b): utente che gestisce i prodotti all'interno del magazzino (inserendo i nuovi prodotti arrivati, eliminando quelli non più disponibili)
