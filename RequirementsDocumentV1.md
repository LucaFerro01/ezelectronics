...
## Table
  1. **User**: un utente del sito che può avere due ruoli: 
    - **Menager**: una o più persone che gestiscono i prodotti all'interno del magazzino (inserendo i nuovi prodotti arrivati)
    - **Customer**: colui che effettua un qualunque acquisto sul sito, tramite diversi metodi di pagamento
