...
|                **Manage products**                |
|  FR3.1  -      Register a set of new product   | insertProduct - should add a product to the database<br>insertProduct should reject with an error if the product already exist<br>|
|  FR3.2  -      Change the quantity of a product   | changeProductQuantity - should add a given quantity to a product<br>changeProductQuantity should return an error if the quantity was less than 1<br>|
|  FR3.3  -      Sell a given product   | sellProduct - should modify the quantity of a sold product<br>sellProduct should return an error if the product doesen't exist<br>| sellProduct should return an error if the aren't enough quantity for the sold<br>|
|  FR3.4   -      Show the list of all products   | getAllProducts - should retrive all the product in the stock|
|  FR3.4.1   -      Show the list of all available products   | availableProducts - should retrive all the product in the stock with quantity greather than 0|
|  FR3.5  -      Show the list of all products with the same category   | getAllProducts - should retrive all the product in the stock with the same category|
|  FR3.5.1  -      Show the list of all available products with the same category   | availableProducts - should retrive all the product in the stock with quanity grather than 0 and the same model|
|  FR3.6  -      Show the list of all products with the same model   | getAllProducts - should retrive all the product in the stock with the same model|
|  FR3.6.1  -      Show the list of all available products with the same model   | availableProducts - should retrive all the product in the stock with quantity greather than 0 with the same model|
|  FR3.7  -      Delete a product   | deleteProduct - should delete a given product|
|  FR3.8  -      Delete a products  | deleteAllProducts - should delete all products|
|                **Manage reviews**                |         
