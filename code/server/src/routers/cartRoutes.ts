...
class CartRoutes {
    ...
    initRoutes() {
         ...
         */
        this.router.patch("/", this.authenticator.isCustomer, (req: any, res: any, next: any) =>
            this.controller
         ...
         */
        this.router.get("/history", this.authenticator.isCustomer, (req: any, res: any, next: any) =>
            this.controller
         ...
         */
        this.router.delete("/current", this.authenticator.isCustomer, (req: any, res: any, next: any) =>
            this.controller
                .clearCart(req.user)
                .then(() => res.status(200).end())
                .catch((err) => next(err))
         ...
         */
        this.router.delete("/", this.authenticator.isAdminOrManager, (_, res: any, next: any) =>
            this.controller
                .deleteAllCarts()
                .then(() => res.status(200).end())
         ...
         */
        this.router.get("/all", this.authenticator.isAdminOrManager, (_, res: any, next: any) =>
            this.controller
                .getAllCarts()
                .then((carts: any /**Cart[] */) => res.status(200).json(carts))
                .catch((err: any) => next(err))
